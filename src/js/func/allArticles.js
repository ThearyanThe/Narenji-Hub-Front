...
const getAndShowAllArticles = async () => {
    const  ArticleWrapper = document.querySelector("#all-articles-wrapper");
    ...
    const result = await res.json();
      ...
      const Articles= paginateItems(result,4,paginationWrapper,PageParam)
     /*corses */
    if(Articles.length){
        ...
        ArticleWrapper.innerHTML = ` <div class="bg-red-500 text-white p-3 rounded-md flex justify-center items-center w-full font-ybakhfat ">
